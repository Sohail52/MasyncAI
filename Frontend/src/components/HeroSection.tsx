      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-semibold text-white leading-tight">
            ...
            <span className="bg-clip-text text-transparent font-semibold bg-gradient-to-r from-[#0066FF] to-[#6366F1] animate-gradient-shift">
              Powered by <span className='text-[#06B6D4]'>AI</span>
            </span>
            </div>
          </h1>
          ...
          <p className="text-base  font-normal text-gray-400 max-w-2xl mx-auto">
            ...
            <span className="text-[#0066FF] font-semibold"> MasyncAI</span>
          </p>
        </motion.div>
        ...
        >
          <div className="backdrop-blur-md bg-gray-900/50 rounded-xl shadow-2xl border border-gray-800/80 overflow-hidden">
            ...
            <div className="p-3">
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-1.5 bg-gradient-to-r from-[#0066FF] to-[#6366F1] hover:from-[#0052CC] hover:to-[#4F46E5] text-white py-2.5 px-5 rounded-md font-medium text-sm transition-all border border-[#0066FF]/40 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#0066FF] focus:ring-offset-1"
              >
