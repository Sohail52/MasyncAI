    ...
    <div className="min-h-screen bg-gray-950 flex flex-col">
      <header className="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center">
            ...
            >
            <img 
              src="data:image/svg+xml;base64," 
              alt="MasyncAI Logo" 
              className="w-6 h-6 relative z-10" 
            />
            <h1 className="text-xl font-semibold text-white">MasyncAI</h1>
            </button>
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors mr-4 bg-[#0B1426] px-3 py-1.5 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
